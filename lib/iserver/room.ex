defmodule Iserver.Room do
  ...
  def comment(pid, c = %{user_id: _, content: _}) do
  ...
  @impl true
  def handle_call({:comment, c = %{user_id: _, content: _}}, _from, room = %__MODULE__{comments: comments}) do
    updated_comments = [Comment.create(c) | comments]
